...
public interface BlogService extends IService<Blog> {
    ...
    Page<BlogVo> getArchiveList(QueryPageBean queryPageBean, Long uid);

    boolean deleteBlog(Long blogId, Long uid);

    Blog getBlogByBlogId(Long blogId);

    void updateBlogByBlogId( AddBlogVo addBlogVo,Long blogId);
}
