    ...
    <div class="home-banner">
      <div class="banner-container">
        <h1 class="blog-title animated zoomIn">
          Welcome to Jiankun's Blog~
        </h1>
        <!-- 联系方式 -->
        <div class="blog-contact animated zoomIn">
          <a class="github circular icon button" target="_blank" href="https://github.com/kun98-liu/" data-content="https://github.com/kun98-liu/" data-position="bottom center" style="margin-right: 0px"><i class="github icon"></i></a>
        </div>
        <!-- 向下滚动 -->
        <div class="scroll-down" @click="scrollDown">
          <h4>Scroll down<i class="el-icon-arrow-down"></i></h4>
        </div>
      </div>
          ...
          <div class="eleven wide column">
            ...
            <div class="ui top attached segment">
              <div class="ui middle aligned two column grid my-shadow">
                <div class="column">
                  <h3 class="ui my-blue header" >Blogs</h3>
                </div>
                <div class="right aligned column"><h4 class="ui header m-inline-block m-text" v-if="pagination.queryString!=='' && pagination.queryString!==null" style="height: 1px !important;">根据"{{pagination.queryString}}"的搜索结果</h4>
                  <h2 class="ui orange header m-inline-block m-text-thin">{{pagination.total}}</h2> In Total
                </div>
              </div>
            </div>
          ...
          <div class="five wide column" style="left: 34px !important;">
            ...
            <div class="ui segments my-shadow">
              <div class="ui secondary segment">
                <div class="ui two column grid">
                  <div class="column">
                    <i class="idea icon"></i>View by type
                  </div>
            ...
            <div class="ui segments m-margin-top-large my-shadow">
              <div class="ui secondary segment">
                <div class="ui two column grid">
                  <div class="column">
                    <i class="tags icon"></i>View By Tag
                  </div>
                  <div class="right aligned column">
            ...
            <div class="ui segments m-margin-top-large my-shadow">
              <div class="ui secondary segment ">
                <i class="bookmark icon"></i>Newly Published
              </div>
  ...
  methods: {
    ...
    message () {
      ...
      if (messageFlag == null) {
        Notification({
          title: 'Message',
          message: 'You are more than welcome to make comments or publish your own blog!',
          duration: 0
        })
        const h = this.$createElement
        Notification({
          title: 'Note',
          message: h('i', { style: 'color: teal' }, 'Some features are not usable now.'),
          duration: 0
        })
      }
    ...
    async findPage () {
      ...
      if (str !== null) {
        ...
        this.$message.info('Not usable now')
      }
