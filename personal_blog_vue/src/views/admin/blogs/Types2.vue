<template>
  <div class="blogs">
    <div class="content-header">
      <h1>Blog Management<small>Types</small></h1>
    ...
    <div class="app-container">
      <div class="box">
        <div class="filter-container">
          <el-input placeholder="Search by Type Name" v-model="pagination.queryString" style="width: 200px;"
      ...
      <div class="ui container">
        <el-table size="middle" current-row-key="id" :data="dataList" stripe highlight-current-row>
          ...
          <el-table-column prop="typeId" min-width="15px" align="center" label="#"></el-table-column>
          <el-table-column prop="typeName" label="Type Name" align="center"></el-table-column>
