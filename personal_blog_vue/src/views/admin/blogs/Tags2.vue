<template>
  <div class="blogs">
    <div class="content-header">
      <h1>Blog Management<small>Tags</small></h1>
    ...
    <div class="app-container">
      <div class="box">
        <div class="filter-container">
          <el-input placeholder="Type Name" v-model="pagination.queryString" style="width: 200px;"
          ...
          <el-button type="primary" class="butT" @click="handleAdd">Add</el-button>
        </div>
      <div class="ui container">
        <el-table size="middle" current-row-key="id" :data="dataList" stripe highlight-current-row>
          <!--                        id,用户名，真实姓名，角色，备注，最后登录时间，创建时间-->
          <el-table-column prop="tagId" min-width="15px" align="center" label="#"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async findPage () {
      ...
      const { data: res } = await this.$http.post('/api/server/tag/findPage', param2)
      // 解析controller响应回的数据
    ...
    // 添加按钮
    handleAdd () {
      this.$message.error('Sorry, you don\'t have this authority!')
      // 进行表单校验
    ...
    handleDelete () {
      this.$message.info('Sorry, you don\'t have this authority!')
    },
    handleUpdate () {
      this.$message.info('Sorry, you don\'t have this authority!')
    }
