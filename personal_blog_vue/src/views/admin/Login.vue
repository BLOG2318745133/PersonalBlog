<template>
    <div class="login_container">
      ...
      <div class="archive-banner banner">
        <h1 class="banner-title">Archives</h1>
      </div>
      <div class="login_box">
      <!-- 头像区域 -->
      <div class="avatar_box">
        ...
        <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
          ...
          <el-form-item prop="password">
            <el-input v-model="loginForm.password" placeholder="Password" prefix-icon="el-icon-moon-night" type="password"></el-input>
          </el-form-item>
          <el-form-item prop="code">
            <el-input v-model="loginForm.code" placeholder="Verify Code" prefix-icon="el-icon-picture-outline-round" style="width: 50%"></el-input>
            <img v-bind:src="verifyCode" @click="getVerifyCode()" width="130px" height="35px" style="float: right;cursor:pointer;" />
          </el-form-item>
          <!-- 按钮区域 -->
          <el-form-item class="btns">
            <el-button type="success" @click="handleCreate">Regist</el-button>
      ...
      <!-- 注册弹层-->
      <div class="add-form">
        <el-dialog title="Regist" :visible.sync="dialogFormVisible">
          <el-form ref="registForm" :model="formData" :rules="loginFormRules" label-position="right"
                   label-width="100px">
            <el-row>
              <el-col :span="12">
                <el-form-item label="Username" prop="username">
                  <el-input label="user" v-model="formData.username"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
          ...
          <el-row>
            ...
            <el-col>
              <el-form-item label="Upload from local">
              <el-upload
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="regist()">Regist</el-button>
          </div>
        </el-dialog>
      </div>
    </div>
  ...
  data () {
    return {
      ...
      formData: {
        ...
        nickname: '',
        email: '',
        avatar: 'https://unsplash.it/100/100?image=1'
      },
        ...
        if (valid) {
          ...
          this.$http.post('/api/server/user/add', param).then((res) => {
            ...
            if (res.data.flag) {
              // 弹出提示信息
              this.$message({
                message: 'Regist Success! Try Login Now!',
                type: 'success'
              })
            } else { // 执行失败
